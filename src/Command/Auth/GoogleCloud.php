...
final class GoogleCloud extends Auth
{
    ...
    protected function help(): void
    {
        ...
        $this->oOutput->writeln('');
        $this->oOutput->writeln('<comment>1:</comment> Generate a new Service Account Key here: <info>https://console.cloud.google.com/apis/credentials/serviceaccountkey</info>');
        $this->oOutput->writeln('<comment>2:</comment> Ensure the following permissions are set');
        $this->oOutput->writeln('  — <info>Compute Image User</info>');
